CREATE INDEX "readLaters_userId_createdAt_idx" ON public."readLaters" USING btree ("userId", "createdAt" DESC);

CREATE INDEX "readLaters_userId_idx" ON public."readLaters" USING btree ("userId");
