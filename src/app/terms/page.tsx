...
export default function TearmsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold text-center mb-6">Zenntaの利用規約</h2>

      <section className="mb-8">
        <h3 className="text-xl font-semibold mb-4">第1条 適用</h3>
      ...
      <section className="mb-8">
        <h3 className="text-xl font-semibold mb-4">第2条 禁止行為</h3>
      ...
      <section className="mb-8">
        <h3 className="text-xl font-semibold mb-4">第3条 責任限界</h3>
        <p className="text-gray-700">
      ...
      <section className="mb-8">
        <h3 className="text-xl font-semibold mb-4">第4条 規約変更</h3>
        <p className="text-gray-700">
      ...
      <section>
        <h3 className="text-xl font-semibold mb-4">第5条 法律と対策</h3>
        <p className="text-gray-700">
