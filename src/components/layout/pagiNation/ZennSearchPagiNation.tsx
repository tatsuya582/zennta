...
export const ZennSearchPagiNation = ({ currentPage, next, buildHref }: ZennSearchPagiNationProps) => {
  return (
    <Pagination>
      <PaginationContent>
        {currentPage !== 1 && (
          <>
            ...
            {currentPage >= 4 && (
              <PaginationItem>
                <PaginationLink href={buildHref(currentPage - 3)}>{currentPage - 3}</PaginationLink>
              </PaginationItem>
            )}
            {currentPage >= 3 && (
              <PaginationItem>
